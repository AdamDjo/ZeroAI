Create one horizontal animation strip for Codex pet `chimi`, state `running-right`.
...
Identity: same pet in every frame: Preserve Chimi identity: compact round cream cat, black triangular ears, black curved tail, lime collar medallion, lime tail orb, tiny dark mouth, coral cheeks, front-facing readable pixel art. No new props, text, shadows, detached effects, scenery, checkerboard, white background, or style drift.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `pixel`: Pixel-art-adjacent digital mascot with a chunky silhouette, simple dark outline, limited palette, flat cel shading, and visible stepped edges. User style notes: Crisp hard-edged pixel art, compact full-body silhouette, five-color identity inspired by the master, readable at Codex pet size..
